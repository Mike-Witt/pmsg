#
# t d s e _ d e m o . p y
#
# Python demo code to go along with csim_tdse.pyx. To run it do:
#
#   ipython -i --pylab tk tdse_demo.py
#
# Then run the demo:
#
#   demo() # This will do a small barrier that "splits" the wave
#
# For a larger barrier that effectively reflects the wave:
#
#   demo(v0=20, v1=30, vh=1, sim_time=130)
#
# You can make the demo run slower with the "real_time" arguments.
# This *should* take 30 seconds to run:
#
#   demo(real_time=30)
#
# If your processor can't run the simulation fast enough to finish in
# the time specified by real_time, then you'll see the message:
#
#   Can't keep up
#
# and it will just finish as fast as it can. My ThinkPad T420 can do
# something like demo(real_time=10). That's what the default is set to.
# 
# There are various other parameters, both calling arguments and things
# that can be tweaked by editing the code. Hopefully the comments below
...
def demo(
    ...
    # Wait for the user at this point
